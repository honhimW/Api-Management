...
!(function () {
  function a (b, c) {
    if (!b || typeof b === 'function') return c
    var d = {}
    for (var e in c) d[e] = c[e]
    for (e in b) b[e] && (d[e] = typeof d[e] === 'object' ? a(d[e], b[e]) : b[e])
    return d
  }
  ...
  function e (a, b, c, d, e, f, g, h) {
    ...
    return i = (h - f) * (c - a) - (g - e) * (d - b), i === 0 ? n : (j = b - f, k = a - e, l = (g - e) * j - (h - f) * k, m = (c - a) * j - (d - b) * k, j = l / i, k = m / i, n.x = a + j * (c - a), n.y = b + j * (d - b), j > 0 && j < 1 && (n.onLine1 = !0), k > 0 && k < 1 && (n.onLine2 = !0), n)
  }
  ...
  function n (a) {
    ...
    function c (a) {
      var b = 'next',
        c = a.indexOf('(') + 1,
        d = a.indexOf(')')
      return c >= 0 && d >= 0 && (b = D.substring(c, d), b.indexOf(',') < 0 && b !== 'yes' && b !== 'no' && (b = 'next, ' + b)), b
    }
    a = a || '', a = a.trim()
    for (var d = {
        symbols: {},
  ...
  Array.prototype.indexOf || (Array.prototype.indexOf = function (a) {
    ...
    if (c === 0) return -1
    var d = 0
    if (arguments.length > 0 && (d = Number(arguments[1]), d != d ? d = 0 : d !== 0 && 1 / 0 != d && d != -1 / 0 && (d = (d > 0 || -1) * Math.floor(Math.abs(d)))), d >= c) return -1
    ...
    if (c === 0) return -1
    var d = c
    arguments.length > 1 && (d = Number(arguments[1]), d != d ? d = 0 : d !== 0 && d != 1 / 0 && d != -(1 / 0) && (d = (d > 0 || -1) * Math.floor(Math.abs(d))))
  ...
  var o = this,
    p = {}
  typeof module !== 'undefined' && module.exports ? module.exports = p : o.flowchart = o.flowchart || p
  var q = {
      x: 0,
      y: 0,
      'line-width': 3,
          ...
          if (c && c !== 'right' || !q || !t) {
            if (c && c !== 'right' || !q || !s) {
              if (c && c !== 'bottom' || !u) {
                ...
                f = this.leftEnd && t ? d(this.chart, j, [{
                  x: j.x,
                  y: j.y + x / 2
                }, {
                  x: j.x + (j.x - n.x) / 2,
